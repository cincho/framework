...
final class EngineTest extends TestCase
{
    ...
    public function testRenderTemplateExtendingAnother(): void
    {
        ...
        $content = '<?php $this->extend("' . $file1 . '"); ?> World';
        $file2 = uniqid();
        ...
        $this->assertEquals('Hello World', $engine->render($file2));

        unlink('/tmp/' . $file1);
        unlink('/tmp/' . $file2);
    }

    public function testRenderTemplateExtendingAnotherWithOverridenSections(): void
    {
    ...
    public function testRenderTemplateExtendingAnotherWithSections(): void
    {
        ...
        $this->assertEquals('<div>Hello Foo</div>', $engine->render($file2));
